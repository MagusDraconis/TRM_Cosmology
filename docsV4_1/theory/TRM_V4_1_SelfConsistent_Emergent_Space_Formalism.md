...
**Test baseline:** 386/386 xUnit tests passing across all V4.1 suites (TEST-RUN-VERIFIED 2026-07-12)
...
| **Total V4.1** | **386** | **All passing, 0 failed, 0 skipped** |

**Verification command:**
```
dotnet test --filter "FullyQualifiedName~V4_1" -v normal
```
**Result:** 386 total, 386 passed, 0 failed, 0 skipped (run 2026-07-12).
