...
public interface IWeakFieldService
{
    ...
    LightDeflectionResult ComputeLightDeflection(WeakFieldBodyPreset body, double impactParameterMultiplier);
    PerihelionResult ComputePerihelion(PerihelionPlanetPreset planet);
}
