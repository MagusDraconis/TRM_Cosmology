...
Close the first-principles derivation of:

\[
O_5,\ \Theta,\ \lambda_\Theta
\]

from TQM microscopic/lattice coupling, while preserving holdout and anti-proxy discipline (no per-galaxy fitting fallback).
