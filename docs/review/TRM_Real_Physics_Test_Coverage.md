...
- **Relevante Tests/Signale:**
  ...
  - `CollectiveModeLockingTests.cs`
    ...
    - RBF50–RBF52: `RBF50_SharedFunctional_Should_Remain_Stable_Under_BoundedWeightPerturbations`, `RBF51_SharedFunctional_Should_Lose_M3Uniqueness_When_Constraints_Are_Relaxed`, `RBF52_SharedFunctional_Should_Show_NoAlternative_AdmissibleCounterexamples_Under_BoundedSearch` (uniqueness stress testing, parameter perturbation, bounded counterexample search)
    - RBF53–RBF55: `RBF53_SharedFunctional_AdmissibleDomain_Should_Have_ExplicitValidityBoundary`, `RBF54_SharedFunctional_BoundaryFailures_Should_Be_Classified_By_DominantConstraintChannel`, `RBF55_SharedFunctional_BoundaryStability_Should_Be_Maintained_Under_BoundedQSupportAndSolverVariants` (domain of validity mapping, boundary failure classification, solver stability)
    ...
    - RBF77–RBF79: `RBF77_TopologicalNecessity_Should_Be_Formulated_AsClosureDefectLemma`, `RBF78_Sufficiency_Should_Be_Formulated_AsEnergyMarginLemma`, `RBF79_DomainClosure_Should_Be_Formulated_AsBoundaryLemma` (lemma scaffolds structuring open analytical proofs for necessity, sufficiency, and domain limits)
