...
**Version:** 5.0
**Date:** 2026-07-26
**Scope:** Clockwork Cosmology V1 through V14.2
**Current Frontier:** V14.2 Mode Origin Principle
**Current Branch:** v14.2-mode-origin-principle (CLOSING)
...
- MOP_02: Mode Origin Principle audit.
- Four wave-mode classes generated by 2×2 grammar.
- G1: Exponent class (standard vs non-standard).
- G2: Modulation (clean vs modulated).
- G2 alone perfectly predicts dT/dp sign (POS ⟺ G2=0, 4/4 correct).
- Primary split: HUB (G2=0) vs SPOKE (G2=1).

V14.3 NEXT
Research focus:
Wave Grammar Principle.
Determine why these specific (G1, G2) combinations are dynamically stable.
What deeper wave-structure determines admissible mode classes?
