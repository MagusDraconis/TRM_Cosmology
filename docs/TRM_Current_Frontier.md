...
**Current Version:** V14.2 MODE ORIGIN PRINCIPLE
**Current Branch:** v14.2-mode-origin-principle (CLOSING)
**Cumulative Tests:** ~3920
**Failed:** 0
...
V14.2 MODE ORIGIN PRINCIPLE. The four wave-mode classes are generated
by a 2×2 grammar: G1 (exponent class: standard vs non-standard) ×
G2 (modulation: clean vs modulated). G2 alone perfectly predicts
dT/dp sign (POS ⟺ G2=0, 4/4 correct). The primary organizational
split is HUB vs SPOKE, determined by modulation presence.
...
## Current Research Question (V14.2)

The four wave-mode classes are generated by a 2×2 grammar
(G1: exponent class, G2: modulation). The next frontier is
determining whether this grammar itself emerges from a deeper
wave-structure principle — i.e., what determines which combinations
of exponent class and modulation are dynamically stable.
