...
| Item | Value |
|:-----|:------|
| Current Version | V5.9 COMPLETE → V5.10 INITIALIZED |
...
| V5.9 | BCP→BCI | Directional commitment: Hi→Lo possible (14-31%), Lo→Hi locked (0%) at CP5. N=71 transition-plastic. Prediction before full irreversibility. |
